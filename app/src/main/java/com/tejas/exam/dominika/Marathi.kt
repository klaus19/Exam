        ...
        binding.root.apply {
         ...
         with(binding){
             ...
             txtViewAnswer1Marathi.setOnClickListener {
                 textAnswer1Marathi.visibility = if (textAnswer1Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }

             txtViewAnswer2Marathi.setOnClickListener {
                 textAnswer2Marathi.visibility = if (textAnswer2Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }

             txtViewAnswer3Marathi.setOnClickListener {
                 textAnswer3Marathi.visibility = if (textAnswer3Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }

             txtViewAnswer4Marathi.setOnClickListener {
                 textAnswer4Marathi.visibility = if (textAnswer4Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }

             txtViewAnswer5Marathi.setOnClickListener {
                 textAnswer5Marathi.visibility = if (textAnswer5Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }

             txtViewAnswer6Marathi.setOnClickListener {
                 textAnswer6Marathi.visibility = if (textAnswer6Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }

             txtViewAnswer7Marathi.setOnClickListener {
                 textAnswer7Marathi.visibility = if (textAnswer7Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }

             txtViewAnswer8Marathi.setOnClickListener {
                 textAnswer8Marathi.visibility = if (textAnswer8Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer9Marathi.setOnClickListener {
                 textAnswer9Marathi.visibility = if (textAnswer9Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer10Marathi.setOnClickListener {
                 textAnswer10Marathi.visibility = if (textAnswer10Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer11Marathi.setOnClickListener {
                 textAnswer11Marathi.visibility = if (textAnswer11Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer12Marathi.setOnClickListener {
                 textAnswer12Marathi.visibility = if (textAnswer12Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer13Marathi.setOnClickListener {
                 textAnswer13Marathi.visibility = if (textAnswer13Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer14Marathi.setOnClickListener {
                 textAnswer14Marathi.visibility = if (textAnswer14Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer15Marathi.setOnClickListener {
                 textAnswer15Marathi.visibility = if (textAnswer15Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer16Marathi.setOnClickListener {
                 textAnswer16Marathi.visibility = if (textAnswer16Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer17Marathi.setOnClickListener {
                 textAnswer17Marathi.visibility = if (textAnswer17Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer18Marathi.setOnClickListener {
                 textAnswer18Marathi.visibility = if (textAnswer18Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer19Marathi.setOnClickListener {
                 textAnswer19Marathi.visibility = if (textAnswer19Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer20Marathi.setOnClickListener {
                 textAnswer20Marathi.visibility = if (textAnswer20Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer21Marathi.setOnClickListener {
                 textAnswer21Marathi.visibility = if (textAnswer21Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer22Marathi.setOnClickListener {
                 textAnswer22Marathi.visibility = if (textAnswer22Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer23Marathi.setOnClickListener {
                 textAnswer23Marathi.visibility = if (textAnswer23Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer24Marathi.setOnClickListener {
                 textAnswer24Marathi.visibility = if (textAnswer24Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
             txtViewAnswer25Marathi.setOnClickListener {
                 textAnswer25Marathi.visibility = if (textAnswer25Marathi.visibility == View.INVISIBLE) View.VISIBLE else View.INVISIBLE
             }
